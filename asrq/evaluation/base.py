...
def requires_audio_files(generate_fn) -> bool:
    return generate_fn.__name__ in {"generate_parakeet", "generate_canary"}
...
def evaluate_openasr(modelQ, cfg, generate_fn, evaluation_results_file, create_audio_files=False):
    ...
    for dataset, split in dataset_split:
        ...
        result = evaluate_model(
            ...
            batches_to_eval=None, create_audio_files=create_audio_files or requires_audio_files(generate_fn)
        )
